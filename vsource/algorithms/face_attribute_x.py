...
def face_attribute_y(image_path, version='cgy-2', max_interval=configs.max_interval):
    # default version:
    algorithm_name = 'face_attribute'
    algorithm_version = 'cgy-2'
    algorithm_port = 17782
    algorithm_ip   = '120.26.143.61'
...
def face_attribute_z(image_path, version='cgy-1', max_interval=configs.max_interval):
    # default version:
    algorithm_name = 'face_attribute'
    algorithm_version = 'cgy-1'
    algorithm_port = 17783
    algorithm_ip   = '120.26.143.61'
