...
@LastEditors: Kermit
@LastEditTime: 2022-11-05 16:17:17
'''
...
def remove_bg(image_path, version='cgy', max_interval=configs.max_interval):
    # default version:
    algorithm_name = 'remove_bg'
    algorithm_version = '1.0.1'
    algorithm_port = 17777
    ...
    while True:
        ...
        if face_ans['result']['status'] == 'error':
            return -1
        image_path = face_ans['result']['result']['result']
